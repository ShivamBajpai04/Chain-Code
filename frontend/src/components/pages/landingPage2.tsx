...
export default function UpdatedLandingPage() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-blue-50 to-white overflow-hidden">
      ...
      {/* Header with simplified underline effect */}
          ...
          <div className="flex h-16 items-center justify-between bg-white/80 backdrop-blur-md rounded-full border border-gray-200 shadow-md px-6 hover:shadow-lg transition-shadow duration-300">
            <div className="flex items-center gap-8">
              ...
              <nav className="hidden md:flex gap-8" aria-label="Main Navigation">
                {["Features", "Practice", "Innovate", "Own"].map((item, index) => (
                  <Button key={item} variant="link" className="text-[#241e58]/80 hover:text-blue-600 px-0 h-8 relative">
